...
int compteur = 0, attente = 3;                                                                    // Variables de temporisation de la mesure de la température; le temps entre chaque prise d'information sera de attente * 250ms 
...
void loop() {
  ...
  if(compteur == 0)                                                                               // Condition afin de réaliser la lecture de température
  {
    valeur_temp = analogRead(lecture_temp)*5.0*100.0/1023.0;                                      // Lecture de la valeur de température
  }
  else
  {
    valeur_temp = valeur_temp;
  }                                       

  compteur = (compteur + 1) % attente;                                                            // Variables qui permet de temporisé la lecture de la temérature
