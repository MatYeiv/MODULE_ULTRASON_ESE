...
int lecture_temp = A0, lecture1 = A1, lecture2 = A2, lecture3 = A3;

int sortie_temp = 6,sortie1 = 5, sortie2 = 4, sortie3 = 3;

float valeur_temp = 0, valeur1 = 0, valeur2 = 0, valeur3 = 0;

const float SEUIL_TENSION = 2.4, SEUIL_TEMPERATURE = 24.0;
...
void loop() {
  ...
  valeur_temp = analogRead(lecture_temp)*5.0*100.0/1023.0;
  ...
  if(valeur_temp > SEUIL_TEMPERATURE)
  {
